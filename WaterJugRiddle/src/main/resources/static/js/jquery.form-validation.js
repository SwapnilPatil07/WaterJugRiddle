var Validator = function () {
    function Validator($selector, options) {
        ...
        options = $.extend({
            ...
            fieldLabelSuccessClass: 'text-success',
            fieldLabelErrorClass: 'text-danger',
        ...
        this.$label= this.$parent.find(options.fieldLabel);
        ...
        if (firstError){
            ...
            this.$label.removeClass(this.options.fieldLabelSuccessClass).addClass(this.options.fieldLabelErrorClass);
            ...
            this.$label.removeClass(this.options.fieldLabelErrorClass).addClass(this.options.fieldLabelSuccessClass);
        }
    ...
    Validator.prototype.language = {
        ...
        mustNotContainCharacter : 'The {label} must be a integer.'
    };
